...
<fmt:message key="error403.title" var="title"/>
<fmt:message key="error403.message" var="message"/>
<fmt:message key="error403.redirect.first" var="redirect_first"/>
<fmt:message key="error403.redirect.home" var="redirect_home"/>
<fmt:message key="error403.redirect.second" var="redirect_second"/>
