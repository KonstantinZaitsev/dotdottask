...
<fmt:message key="error500.redirect.first" var="redirect_first"/>
<fmt:message key="error500.redirect.home" var="redirect_home"/>
<fmt:message key="error500.redirect.second" var="redirect_second"/>
