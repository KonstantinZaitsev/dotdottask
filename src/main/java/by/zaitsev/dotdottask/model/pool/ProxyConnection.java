...
/**
 * The ProxyConnection is wrapper for {@link Connection} class, used to control the creation and closing of
 * {@link Connection}s.
 *
...
record ProxyConnection(Connection connection) implements Connection {
    /**
     * Used to close the {@link Connection} instead of the {@link #close()} method.
     *
